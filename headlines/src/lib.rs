...
// If i name it lib.rs, it is treated as a library crate

use std::{sync::mpsc::{channel, sync_channel}, thread};

use eframe::{egui::{CentralPanel, CtxRef, Hyperlink, Label, ScrollArea, Separator, TextStyle, TopBottomPanel, Ui, Visuals}, epi::App};
...
// wasm bindgen is a macro which is exposed to us from the wasm bindgen crate
// which comes from eframe crate
